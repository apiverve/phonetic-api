...
namespace APIVerve.API.PhoneticEncoder
{
    ...
    /// <summary>
    /// Client for the PhoneticEncoder API
    /// </summary>
    public class PhoneticEncoderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/phonetic";
        ...
        public PhoneticEncoderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PhoneticEncoderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PhoneticEncoderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PhoneticEncoderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PhoneticEncoderQueryOptions options)
        {
        ...
        public ResponseObj Execute(PhoneticEncoderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PhoneticEncoderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PhoneticEncoderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PhoneticEncoderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PhoneticEncoderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PhoneticEncoderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PhoneticEncoderQueryOptions options)
        {
