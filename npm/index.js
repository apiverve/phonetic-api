...
class phoneticWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/phonetic');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/phonetic';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"word":{"type":"string","required":true},"algorithm":{"type":"string","required":false,"default":"both"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/phonetic`);
        }
    }
...
module.exports = phoneticWrapper;
