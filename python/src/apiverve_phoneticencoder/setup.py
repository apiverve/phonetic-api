...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/phonetic',
        'Source': 'https://github.com/apiverve/phonetic-api',
        'Bug Tracker': 'https://github.com/apiverve/phonetic-api/issues'
    },
    classifiers=[
