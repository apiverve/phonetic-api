...
```gradle
dependencies {
    implementation 'com.github.apiverve:phonetic-api:1.1.13'
}
```
...
```java
import com.apiverve.phonetic.PhoneticEncoderAPIClient;
import com.apiverve.phonetic.APIResponse;
import com.apiverve.phonetic.APIException;

// Initialize the client
PhoneticEncoderAPIClient client = new PhoneticEncoderAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "smith");
    parameters.put("algorithm", "both");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/phonetic](https://docs.apiverve.com/ref/phonetic)
...
- **Documentation:** [https://docs.apiverve.com/ref/phonetic](https://docs.apiverve.com/ref/phonetic)
- **Issues:** [GitHub Issues](https://github.com/apiverve/phonetic-api/issues)
