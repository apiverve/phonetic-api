# Phonetic Encoder API - Examples

This folder contains example code for using the Phonetic Encoder API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/phonetic',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/phonetic");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/phonetic](https://docs.apiverve.com/ref/phonetic)
