// Package phonetic provides a Go client for the Phonetic Encoder API.
//
// For more information, visit: https://apiverve.com/marketplace/phonetic?utm_source=go&utm_medium=readme
package phonetic
...
const (
	baseURL        = "https://api.apiverve.com/v1/phonetic"
	defaultTimeout = 30 * time.Second
)

// Client is the Phonetic Encoder API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Phonetic Encoder API client.
...
// Execute makes a request to the Phonetic Encoder API with typed parameters.
//
...
//   - word (required): string - The word to encode phonetically
